...
import { _ as _sfc_main$7 } from "./Modal-DnJhQidw.js";
import { _ as _sfc_main$a } from "./ConfirmationModal-yynBYx0y.js";
import { _ as _sfc_main$b } from "./DangerButton-s5hiF3bK.js";
import { _ as _sfc_main$8 } from "./DialogModal-BVqx4RAb.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const displayableRole = (role) => {
      var _a;
      return ((_a = props.availableRoles.find((r) => r.key === role)) == null ? void 0 : _a.name) || "Unknown Role";
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      if (__props.userPermissions.canAddTeamMembers || _ctx.$page.props.auth.user.usertype === "admin") {
        _push(`<div>`);
              ...
              if (__props.availableRoles.length > 0) {
                ...
                ssrRenderList(__props.availableRoles, (role, i) => {
                  _push2(`<button type="button" class="${ssrRenderClass([{
                    ...
                    "rounded-b-none": i !== __props.availableRoles.length - 1
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(__props.team.users, (user) => {
                ...
                } else if (__props.userPermissions.canRemoveTeamMembers || _ctx.$page.props.auth.user.usertype === "admin") {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.team.users, (user) => {
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center" }, [
                        ...
                        }, " Leave ")) : __props.userPermissions.canRemoveTeamMembers || _ctx.$page.props.auth.user.usertype === "admin" ? (openBlock(), createBlock("button", {
                          key: 3,
                          class: "cursor-pointer ms-6 text-sm text-red-500",
