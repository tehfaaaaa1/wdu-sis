            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="py-12 bg-white overflow-hidden shadow-xl sm:rounded-lg h-auto flex flex-col items-center">
                    ...
                    <div class="mx-4 px-4 mt-3 py-5">
                        <p class="text-base text-justify leading-5 tracking-wide"
                            :class="{ 'line-clamp-3': readmore != true }">
                            {{ client.desc }}
                        </p>
                        <SecondaryButton @click="readmore = !readmore">
                            {{ readmore != true ? 'Expand' : 'Collapse' }}
                        </SecondaryButton>
