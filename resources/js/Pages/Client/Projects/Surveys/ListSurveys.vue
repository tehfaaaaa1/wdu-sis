        ...
        <template #header>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <NavLink :href="route('projects', clientSlug)"
                    class="!py-0 focus:!rounded-sm focus:!ring-0 focus:!border-0 !m-0 hover:ring-0 hover:underline !font-semibold !text-lg text-ijo-terang ">
                            ...
                            <tr v-for="survey in filteredSurveys" :key="survey.id"
                                ...
                                <td class="px-6 py-4">
                                    <p v-if="survey.status == 0"
                                        class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded text-center">
                                        DITUTUP</p>
                                    <p v-if="survey.status == 1"
                                        class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded text-center">
                                        DIBUKA</p>
                                </td>
                                <td class="px-6 py-6">
                                    <div class="grid grid-cols-2 gap-x-2 justify-center content-center">
                                        <div v-if="hasFilledSurvey(survey)"
                                            ...
                                            <p class="text-center"
                                                :class="props.user.current_team_id != 1 || props.user.usertype == 'superadmin' ? 'mt-3' : ''">
