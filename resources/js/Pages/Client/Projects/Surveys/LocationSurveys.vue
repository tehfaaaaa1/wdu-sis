...
<template>
    <AppLayout title="List Kuisioner">
        <template #header>
            <HeaderText :href="route('listsurvey', [clientSlug, projectSlug])">
                <span class="text-black">Survey - </span> {{ survey.title }}
            </HeaderText>
        </template>
        ...
        <main class="min-h-screen bg-repeat bg-[('/img/bg-dashboard.png')]">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <div class="flex justify-center items-center">
                            <div class="border-b-1 border-gray-400 h-max">
                                <svg xmlns:mapsvg="http://mapsvg.com" xmlns:dc="http://purl.org/dc/elements/1.1/"
                                    ...
                                    viewBox="0 -30 792.54596 420" preserveAspectRatio="xMidYMid meet">
                                    <path
                                    ...
                                    <path
                                        ...
                                        title="Kalimantan Selatan" id="13" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        title="Nusa Tenggara Barat" id="24" />
                                    <path
                                        ...
                                        title="Nusa Tenggara Timur" id="23" />
                                    <path
                    ...
                    <div id="hoverText" style="display: none;"
                        class="absolute bg-black bg-opacity-70 text-white p-1.5 rounded pointer-events-none z-[1000]">
                        Province Selected
                    </div>
                    <div class="mb-5">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="flex flex-col items-center h-full">
                                <div class="w-full sm:w-[200px]">
                                    <h3 class="text-center text-xl font-semibold">Responden Based <br>All Location
                                        Target</h3>
                                </div>
                                <div
                                    class="mt-5 w-full sm:w-[200px] border border-[#6db445] rounded-[20px] flex items-center justify-center box-border p-10">
                                    <div class="text-5xl">{{ getSurveySubmissions(survey.id) }}/{{ totalTargetResponse
                                        }}</div>
                                </div>
                                <div class="flex-grow flex mt-5">
                                    <ul>
                                        <li v-for="(province, index) in colorProvinces(selectedSurvey).list"
                                            :key="index">
                            ...
                            <div class="flex flex-col items-center justify-center h-full">
                                ...
                                <div class="w-[320px] h-[320px]">
                                    <PieChart :chartData="prepareProvincePieChartData(selectedSurvey, provinces)"
                                        :options="pieChartOptions" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="max-w-7xl mx-3">
                            <div class="grid grid-cols-3 gap-2">
                                <div v-for="(chartData, index) in barChartData" :key="index"
                                    class="flex flex-col items-center h-full mt-3 p-2">
