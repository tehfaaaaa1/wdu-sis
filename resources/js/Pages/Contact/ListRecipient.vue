        ...
        <main class="min-h-screen">
            <div class="mx-auto mt-5 rounded-md max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white rounded-sm">
                        <div class="" v-for="(recipient, index) in recipients" :key="index">
                    ...
                    <template #content>
                        <div class="block w-full border border-gray-300 p-4">
                            <div class="flex justify-between items-center text-base">
                                Recipient name
                                <input v-model="RecipientName" type="text" placeholder="Recipient Name" class="border-0 py-2 shadow-sm ring-1 ring-inset ring-gray-500 focus:ring-gray-500 focus:ring-inset text-sm lg:text-sm sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                    </template>
                    <template #footer>
