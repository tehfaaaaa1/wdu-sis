                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 lg:flex">
                                ...
                                <NavLink class="focus:text-primary" v-if="$page.props.auth.user.usertype === 'superadmin'|| $page.props.auth.user.current_team_id === 5" :href="route('sendEmail')"
                                    :active="route().current('sendEmail')">
                                    Email
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <DropdownLink
                                                v-if="$page.props.jetstream.canCreateTeams && $page.props.auth.user.usertype === 'superadmin'"
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink v-if="$page.props.auth.user.usertype === 'superadmin'"
